...
Set-SCPItem -ComputerName '10.2.1.6' -Credential $cred -AcceptKey -Path (Join-Path (Get-Location) 'wheel_tmp\qrcode-8.2-py3-none-any.whl') -Destination '/home/pi/ME_CAM-DEV' -Force | Out-Null
$s=New-SSHSession -ComputerName '10.2.1.6' -Credential $cred -AcceptKey -ConnectionTimeout 12 -ErrorAction Stop
$cmd=@'
/home/pi/ME_CAM-DEV/venv/bin/pip install --no-cache-dir /home/pi/ME_CAM-DEV/qrcode-8.2-py3-none-any.whl 2>&1 | tail -20
/home/pi/ME_CAM-DEV/venv/bin/python3 -c "import qrcode; print('QR_OK')"
